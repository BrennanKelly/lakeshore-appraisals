/* ==========================================================================
   ABOUT PAGE — Lakeshore Appraisal
   SEO: certified real estate appraiser Southwest Michigan, Robert Surns appraiser,
   licensed appraiser Mattawan, USPAP compliant appraisal Michigan
   ========================================================================== */
...
const faqs = [
  {
    ...
    a: "Most residential appraisals in Southwest Michigan are completed within 48–72 hours of the property inspection. Complex properties, commercial appraisals, or rush orders may vary. Robert will give you a specific timeline when you order.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Robert Surns is approved by major lenders, banks, credit unions, and mortgage companies operating in Michigan. All reports are USPAP-compliant and meet secondary market requirements.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes — lakefront and waterfront property appraisal is one of our specialties. Robert has extensive experience valuing Lake Michigan shoreline properties, inland lake cottages, and waterfront estates throughout Van Buren, Allegan, and Berrien Counties.",
  },
  {
    q: "How much does a real estate appraisal cost in Michigan?",
    a: "Appraisal fees vary based on property type, complexity, and location. Residential appraisals typically range from $350–$600. Commercial and complex properties are quoted individually. Contact us at (269) 598-4008 for a specific fee quote.",
  },
];
      ...
      <section className="bg-[oklch(0.22_0.005_260)] text-white py-16" aria-label="About page header">
        <div className="container">
          ...
          <h1 className="text-3xl md:text-5xl font-black text-white mb-4" style={{ fontFamily: "'Merriweather', serif" }}>
            Meet Robert Surns,<br />
            <span className="text-[oklch(0.72_0.12_245)]">Lakeshore Appraisal</span>
          </h1>
          <p className="text-[oklch(0.78_0.005_260)] max-w-2xl leading-relaxed">
            For over 20 years, Lakeshore Appraisal has provided accurate, impartial,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-[oklch(0.35_0.005_260)] leading-relaxed">
                <p>
                  Lakeshore Appraisal was founded by Robert Surns with a simple mission: to provide
                ...
                <p>
                  Based in Mattawan and serving the broader Southwest Michigan market — including
                  Kalamazoo, Portage, Paw Paw, and dozens of surrounding communities in Van Buren County
                  and Kalamazoo County — Robert has built his reputation on a foundation of local market
                  expertise, professional integrity, and unwavering commitment to accuracy.
                </p>
                <p>
                  Robert is not just a licensed professional — he is a Southwest Michigan
                  resident who understands the unique dynamics of the local real estate market.
                  From Kalamazoo's diverse urban neighborhoods to the lakefront properties of
                  Van Buren County and the growing communities of Portage and Mattawan, Robert brings
                  genuine local knowledge to every assignment.
                </p>
                <p>
                  Over the past two decades, Robert has completed more than 5,000 appraisals and earned
                  the trust of hundreds of lenders, attorneys, estate planners, and homeowners across
                  Southwest Michigan. Lakeshore Appraisal is proud to be the region's trusted independent
                  appraisal firm.
                </p>
              </div>
            </div>
            <div className="relative">
              <img
                src={APPRAISER_IMG}
                alt="Robert Surns, Lakeshore Appraisal certified appraiser inspecting a Southwest Michigan home"
      ...
      <section className="py-16 bg-[oklch(0.48_0.14_245)]" aria-label="Contact CTA">
        <div className="container text-center">
          ...
          <p className="text-white/80 mb-8 max-w-lg mx-auto">
            Contact Lakeshore Appraisal today for a free quote on your residential
            appraisal anywhere in Southwest Michigan.
          </p>
