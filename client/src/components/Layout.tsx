      ...
      <div className="bg-[oklch(0.22_0.005_260)] text-white text-sm py-2 px-4">
        <div className="container flex items-center justify-between gap-4">
          <div className="flex items-center gap-4 flex-wrap">
            <a href="tel:+12695550142" className="flex items-center gap-1.5 hover:text-[oklch(0.72_0.12_85)] transition-colors">
              <Phone size={13} />
              <span className="font-semibold">(269) 555-0142</span>
            </a>
            <a href="mailto:info@lakeshoreappraisals.com" className="flex items-center gap-1.5 hover:text-[oklch(0.72_0.12_85)] transition-colors hidden sm:flex">
              <Mail size={13} />
              <span>info@lakeshoreappraisals.com</span>
            </a>
          </div>
          <div className="flex items-center gap-1.5 text-[oklch(0.72_0.12_85)]">
            <MapPin size={13} />
      ...
      >
        <div className="container flex items-center justify-between py-4">
          ...
          <Link href="/" className="flex flex-col leading-tight group">
            <span
              className="text-xl font-black tracking-tight text-[oklch(0.22_0.005_260)] group-hover:text-[oklch(0.32_0.09_140)] transition-colors"
              style={{ fontFamily: "'Merriweather', serif" }}
            >
              Lake Shore
            </span>
            <span
              className="text-xs font-bold uppercase tracking-[0.2em] text-[oklch(0.32_0.09_140)]"
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={`text-sm font-bold uppercase tracking-wide transition-colors relative pb-1 ${
                  location === link.href
                    ? "text-[oklch(0.32_0.09_140)] after:absolute after:bottom-0 after:left-0 after:w-full after:h-0.5 after:bg-[oklch(0.32_0.09_140)]"
                    : "text-[oklch(0.35_0.005_260)] hover:text-[oklch(0.32_0.09_140)]"
                }`}
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              className="lg:hidden p-2 text-[oklch(0.22_0.005_260)] hover:text-[oklch(0.32_0.09_140)] transition-colors"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="lg:col-span-1">
              <div className="mb-4">
                ...
                <div className="text-xs font-bold uppercase tracking-[0.2em] text-[oklch(0.72_0.12_85)]" style={{ fontFamily: "'Lato', sans-serif" }}>
                  Real Estate Appraisals
                </div>
              </div>
            ...
            {/* Services */}
            <div>
              <h3 className="text-sm font-bold uppercase tracking-[0.15em] text-[oklch(0.72_0.12_85)] mb-5" style={{ fontFamily: "'Lato', sans-serif" }}>
                Our Services
              </h3>
                ...
                {[
                  ...
                  <li key={area}>
                    <Link href="/service-areas" className="text-sm text-[oklch(0.75_0.005_260)] hover:text-white transition-colors flex items-center gap-2">
                      <MapPin size={12} className="text-[oklch(0.72_0.12_85)] flex-shrink-0" />
                      {area}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-4 mb-6">
                <li className="flex items-start gap-3">
                  <Phone size={15} className="text-[oklch(0.72_0.12_85)] mt-0.5 flex-shrink-0" />
                  <div>
                    <div className="text-xs text-[oklch(0.55_0.005_260)] uppercase tracking-wide mb-0.5">Phone</div>
                    <a href="tel:+12695550142" className="text-sm text-white hover:text-[oklch(0.72_0.12_85)] transition-colors font-semibold">
                      (269) 555-0142
                    </a>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <Mail size={15} className="text-[oklch(0.72_0.12_85)] mt-0.5 flex-shrink-0" />
                  <div>
                    <div className="text-xs text-[oklch(0.55_0.005_260)] uppercase tracking-wide mb-0.5">Email</div>
                    <a href="mailto:info@lakeshoreappraisals.com" className="text-sm text-white hover:text-[oklch(0.72_0.12_85)] transition-colors">
                      info@lakeshoreappraisals.com
                    </a>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <MapPin size={15} className="text-[oklch(0.72_0.12_85)] mt-0.5 flex-shrink-0" />
                  <div>
